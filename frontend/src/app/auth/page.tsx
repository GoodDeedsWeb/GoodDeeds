    ...
    return (
      <main className="root grid">
        ...
        <div className="grid gap-8 justify-items-center content-center">
          ...
          <p className="text-xl">On this site you can do good deeds, make friends and share your good deeds with them.</p>
          <div className="formWrap w-1/5">{form}</div>
          <p id="helper-text" className="mt-2 text-sm text-gray-500 ">{helperText} <a href={linkForAction} className="font-medium text-blue-600 hover:underline">{action}</a>.</p>
        </div>
      </main>
    );
}